            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="display-5 mb-4">Trusted By 200 + satisfied
                        clients</h1>
                    <p class="mb-4">Discover a world of creativity and craftsmanship! From handmade treasures to unique
                        artisanal creations, we bring you the finest collection of crafts made with passion and care.
                        Explore our carefully curated selection to find the perfect addition to your home, a thoughtful
                        gift, or an inspiring piece to cherish. Celebrate the artistry of craft makers and shop with
                        confidence for something truly special.</p>
                    <div class="row g-4 text-dark mb-5">
                        <div class="col-sm-6">
                            <i class="fas fa-share text-primary me-2"></i>Home Delivery
                        </div>
                        <div class="col-sm-6">
                            <i class="fas fa-share text-primary me-2"></i>24/7
                            Customer Support
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <i class="fas fa-share text-primary me-2"></i>Shop Unique Crafts
                        </div>
                    </div>
                    <a href class="btn btn-primary py-3 px-5 rounded-pill">About
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            <p><i class="fa fa-map-marker-alt text-primary me-2"></i> CraftLoving Store,Pimpri
