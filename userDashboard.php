    ...
    <body>
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-cheese fa-7x text-primary mb-4"></i>
                                    <h4 class="mb-3">Wedding Services</h4>
                                    <p class="mb-4">Contrary to popular belief,
                                        ipsum is not simply random.</p>
                                    <a href="#"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-pizza-slice fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-hotdog fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-hamburger fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-wine-glass-alt fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-walking fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-wheelchair fa-7x text-primary mb-4"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp"
                        ...
                        <div class="bg-light rounded service-item">
                            <div
                                ...
                                <div class="service-content-icon text-center">
                                    <i
                                        class="fas fa-utensils fa-7x text-primary mb-4"></i>
            ...
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small
                        ...
                        Events</small>
                    <h1 class="display-5 mb-5">Our Social & Professional Events
                        Gallery</h1>
                </div>
                        ...
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">All Events</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Wedding</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Corporate</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Cocktail</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <div
                                            ...
                                            data-wow-delay="0.1s">
                                            <div
                                                class="event-img position-relative">
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-1.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Wedding</h4>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-2.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Corporate</h4>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-4.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Buffet</h4>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-5.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Cocktail</h4>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-7.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Buffet</h4>
                                                    <a href="img/event-7.jpg"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img
                                                    class="img-fluid rounded w-100"
                                                    src="img/event-8.jpg" alt>
                                                <div
                                                    class="event-overlay d-flex flex-column p-4">
                                                    <h4
                                                        class="me-auto">Corporate</h4>
                                                    <a href="img/event-8.jpg"
            ...
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small
                        class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Our
                        Menu</small>
                    <h1 class="display-5 mb-5">Most Popular Food in the
                        World</h1>
                </div>
                <div class="tab-class text-center">
                    <ul
                        ...
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Starter</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Main Course</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a
                        ...
                        <li class="nav-item p-2">
                            <a
                                ...
                                <span class="text-dark"
                                    style="width: 150px;">Our Spesial</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                                ...
                                <div class="col-lg-6 wow bounceInUp"
                                    ...
                                    <div
                                        ...
                                        <img
                                            ...
                                            src="img/menu-01.jpg" alt>
                                        <div
                                            class="w-100 d-flex flex-column text-start ps-4">
                                            <div
                                                class="d-flex justify-content-between border-bottom border-primary pb-2 mb-2">
                                                <h4>Paneer</h4>
                                                <h4
                                                    class="text-primary">$90</h4>
                                            </div>
                                            <p class="mb-0">Consectetur
                                                adipiscing elit sed dwso eiusmod
        ...
        <div class="container-fluid contact py-6 wow bounceInUp"
            ...
            <div class="container">
                <div class="row g-0">
                    <div class="col-1">
                        <img src="img/background-site.jpg"
                        ...
                        <div
                            ...
                            <div class="text-center">
                                <small
                                    ...
                                    Us</small>
                                <h1 class="display-5 mb-5">Where you want Our
                                    Services</h1>
                            </div>
                            <div class="row g-4 form">
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit"
                                        class="btn btn-primary px-5 py-3 rounded-pill">Submit
                                        Now</button>
                                </div>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="testimonial-item rounded bg-light">
                        ...
                        <div class="testimonial-content">
                            ...
                            <p class="fs-5 m-0 pt-3">Lorem ipsum dolor sit amet
                ...
                <div class="row gx-4 justify-content-center">
                    <div class="col-md-6 col-lg-4 wow bounceInUp"
                        ...
                        <div class="blog-item">
                            ...
                            <div
                                class="blog-content mx-4 d-flex rounded bg-light">
                                ...
                                <a href="#"
                                    class="h5 lh-base my-auto h-100 p-3">How to
                                    get more test in your food from</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow bounceInUp"
