      ...
      <div class="container">
         <div class="row g-5 align-items-center">
            <div class="col-lg-7 col-md-12">
               ...
               <a href="product.php" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Order
                  Now</a>
            ...
            <div class="row g-4 align-items-center">
                    ...
                    <div class="row g-4">
                        <div class="col-sm-4 wow bounceInUp" data-wow-delay="0.3s">
                            <div class="faqt-item bg-primary rounded p-4 text-center">
                                ...
                                <h1 class="display-4 fw-bold" data-toggle="counter-up">443</h1>
                        ...
                        <div class="col-sm-4 wow bounceInUp" data-wow-delay="0.5s">
                            <div class="faqt-item bg-primary rounded p-4 text-center">
                                ...
                                <p class="text-dark text-uppercase fw-bold mb-0">Unique
                                    Craft Ideas</p>
                            </div>
                        </div>
                        <div class="col-sm-4 wow bounceInUp" data-wow-delay="0.7s">
                            <div class="faqt-item bg-primary rounded p-4 text-center">
                                ...
                                <h1 class="display-4 fw-bold" data-toggle="counter-up">450</h1>
                                <p class="text-dark text-uppercase fw-bold mb-0">Orders
                                    Completed</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="image-section">
                        <!-- Add Image Here -->
                        <img src="img/image12.jpg" alt="Craft Image" class="img-fluid rounded">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                    <small
                        ...
                        Team</small>
                    <h1 class="display-5 mb-5">We have creative artists team</h1>
                </div>
                <div class="row g-4">
